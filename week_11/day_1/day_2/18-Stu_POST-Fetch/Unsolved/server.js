...
app.post('/api/reviews', (req, res) => {
  ...
  // This line destructures product, review, and username from the request body
  ...
  // TODO: Add a comment describing why we would check to see if the following properties exist before entering the code block
   // Checking if product, review, and username exist in the request --- making sure the review has all of the data
  if (product && review && username) {
    ...
    // Respond with a JSON object --- returning response to the client
    res.status(201).json(response);
  } else {
    // TODO: Add a comment describing the purpose of the else statement in this POST request.
    // If any of the properties are missing, respond with an error ---- return the error to the client
