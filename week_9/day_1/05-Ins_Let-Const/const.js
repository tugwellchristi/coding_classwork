/*
    HOISTING
        - Behind the scenes, before javascript executes the code it look all all of the declarations for variables and functions 
        moves them to the top to create memory and space allocation.
*/
...
// Once you declare a variable with const, you can no longe reassign with the = operator
